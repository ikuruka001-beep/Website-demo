...
export default function Register(){
  ...
  async function submit(e){ e.preventDefault(); try{ const r=await axios.post('/api/auth/register',{email,password}); saveToken(r.data.token); window.location.href='/' }catch(e){ alert(e.response?.data?.error || e.message) } }
  return (
